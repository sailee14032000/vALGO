...
class vALGO(object):
    def __init__(self):
        ...
        self.logoimagefilename = self.resource_path('png\\logoc.png')
        self.logo = PhotoImage(file=self.logoimagefilename)
    ...
    def dashboard_page(self,parentframe):
        ...
        algo = settings.algos(contents)
        algoimg = self.resource_path('png\\binarytree.png')
